...
> Launch it. Keep it alive. Teleport it.
...
|---|---|---|---|
| **Launch** | `claude-remote` | Spawn Remote Control sessions in detached tmux panes, get the claude.ai/code URL | [claude-remote-launcher](https://github.com/superbereza/claude-remote-launcher) |
...
A typical multi-machine setup: **launch** working sessions on a server with
